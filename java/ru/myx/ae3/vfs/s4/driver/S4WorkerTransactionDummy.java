 ...
 * @param <R>
 * @param <L> */
public class S4WorkerTransactionDummy<O extends RecImpl, R extends RefImpl<O>, L extends Object> //
		implements
	...
	/** @param iface */
	public S4WorkerTransactionDummy(final S4WorkerInterface<O, R, L> iface) {
