...
final class TaskLocalReferenceSearchEquals //
		extends
	...
	TaskLocalReferenceSearchEquals(//
	...
	protected void execute(final S4WorkerContext context) throws Exception {
		...
		final int limit;
		if (leftTotal == 0 || leftTotal > TaskLocalReferenceSearchEquals.LONG_THRESHOLD) {
			limit = this.leftCurrent = TaskLocalReferenceSearchEquals.LONG_ITERATION + 1;
		} else {
			limit = leftTotal;
			this.leftCurrent = 0;
		}
